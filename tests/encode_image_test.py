...
import base64
from app.utils import encode_image  # Adjust this import according to your project structure
...
@pytest.mark.parametrize("image_format, expected_mode", [
    ("JPEG", "RGB"),
    ("PNG", "RGB"),
    ("GIF", "P"),
    ("BMP", "RGB"),
])
def test_encode_image(image_format, expected_mode):
    mock_image_data = create_image_data(image_format)
    encoded_image, result_format = encode_image(mock_image_data)
